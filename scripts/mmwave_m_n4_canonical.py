...
def main() -> int:
    out_dir = ROOT / "datasets/mmwave/manifests/m_n4_canonical"
    summary = freeze_split_and_index(out_dir)
    errors = contract_self_check()
    print(json.dumps({"summary": summary, "self_check_errors": errors}, indent=2))
    if errors:
        return 1
    return 0
