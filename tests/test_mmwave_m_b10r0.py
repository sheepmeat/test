...
from scripts.mmwave_m_b10r0_holdout_policy import OUT_DIR_REL, generate_m_b10r0_evidence
...
class MB10R0PolicyTests(unittest.TestCase):
    ...
    def test_generator_produces_expected_decision(self) -> None:
        ...
        try:
            ...
            dest.mkdir()
            # Regenerate into temp by copying logic path - use full regen then move
