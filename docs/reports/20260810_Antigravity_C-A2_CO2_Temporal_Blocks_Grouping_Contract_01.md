...
Phase **C-A2** establishes a deterministic, evidence-backed temporal interpretation and group-aware split policy contract for the real UCI Occupancy Detection source rows read via the C-A1 safe reader ([`datasets/co2/raw_reader.py`](file:///Users/junwoo/Library/Mobile%20Documents/com~apple~CloudDocs/대학/2026/embed2/datasets/co2/raw_reader.py)).
