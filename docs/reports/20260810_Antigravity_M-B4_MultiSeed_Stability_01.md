...
- **`M-B3_CONV1D_GAP_BASELINE`** achieved top worst-seed validation Macro F1 (`0.329107`), top mean Macro F1 (`0.481275`), and zero collapsed seeds across all initialization seeds `[42, 43, 44]`.
- **`NONE`** is retained as a valid backup stable architecture.
