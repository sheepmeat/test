...
Phase **C-A1** establishes a safe, deterministic, read-only reader module ([`datasets/co2/raw_reader.py`](file:///Users/junwoo/Library/Mobile%20Documents/com~apple~CloudDocs/대학/2026/embed2/datasets/co2/raw_reader.py)) and source-row provenance contract for the real UCI Occupancy Detection dataset used by the SafeNest CO₂ track.
...
The C-A1 reader is implemented in [`datasets/co2/raw_reader.py`](file:///Users/junwoo/Library/Mobile%20Documents/com~apple~CloudDocs/대학/2026/embed2/datasets/co2/raw_reader.py) as `UCIOccupancyRawReader`.
