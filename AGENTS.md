...
- **CURRENT_TRACK_P_GATE:** `M-PROT-4_AUTHORIZED_READY_TO_START`. `M-PROT-4 = AUTHORIZED / READY_TO_START` but **`M-PROT-4_STARTED = NO`**. Authorization ≠ execution. Do not start M-PROT-4 from docs alone; Sol issues a separate execution prompt. M-PROT-5 remains HARDWARE_DEPENDENT / NOT_STARTED; M-PROT-6 NOT_STARTED.
