...
- M-PROT-2 historical machine-readable fields may still say `sol_review_status=PENDING_REVIEW`; that is frozen evidence of the worker package at creation. Current authority after `#176` merge commit `97b742db…` is **COMPLETE / MERGED**. Do not rewrite those historical JSON fields.
- **CURRENT_TRACK_P_GATE:** `M-PROT-3_PENDING_SOL_REVIEW`. PR `#177` (`research/mmwave-m-prot-3-integration-runtime-wiring`) is **OPEN** at exact head `59c6fad0e5d3efd591b2daeab006d77760c98d58` (corrective round after prior Sol-reviewed head `f6101abb…`). Worker claims wiring correctives CLOSED; **Sol exact-head PASS / MERGE_AUTHORIZED is not recorded**. Do **not** mark M-PROT-3 COMPLETE/MERGED. `M-PROT-4=NOT_AUTHORIZED` until Sol approves and `#177` is merged. Do not start M-PROT-4 from this pointer alone.
